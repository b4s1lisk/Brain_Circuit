...
void loop() {
  ...
  if (slideSwitch) {
    ...
    // F = Green = (0, 143, 0)
    // G = Cyan = (0, 255, 255)
    CircuitPlayground.setPixelColor(0, 166, 0, 255);
    ...
    CircuitPlayground.playTone(NOTE_G4, EIGHTH);
    CircuitPlayground.setPixelColor(3, 0, 0, 0);
    CircuitPlayground.playTone(NOTE_G4, EIGHTH);
    CircuitPlayground.setPixelColor(3, 0, 255, 255);
    CircuitPlayground.playTone(NOTE_G4, EIGHTH);
    CircuitPlayground.setPixelColor(3, 0, 0, 0);
    CircuitPlayground.playTone(NOTE_G4, SIXTEENTH);
    CircuitPlayground.setPixelColor(3, 0, 255, 255);
    CircuitPlayground.playTone(NOTE_G4, SIXTEENTH);
    CircuitPlayground.setPixelColor(3, 0, 0, 0);
    CircuitPlayground.playTone(NOTE_G4, SIXTEENTH);
    ...
    CircuitPlayground.playTone(NOTE_D4, EIGHTH);
